...
<div class="wrapper">
    ...
    <div class="content-wrapper college_con">
        ...
        <section class="content-header">
            <!-- 标题 -->
            <h3>
                共收录<font size="13" color="#a52a2a">350</font>个学者
            </h3>
            <!-- 面包屑导航条 -->
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> 学者库</a></li>
                <li class="active">按院校</li>
            </ol>
                <div class="row">
                    <div class="col-lg-4">
                        <div class="dropdown">
                            <div class="dropbtn">985院校</div>
                            <div class="dropdown-content">
                            <li class="list-group-item"><a href="${pageContext.request.contextPath}/scholar/getScholarsBySchool?school=清华大学">清华大学</a></li>
                            <li class="list-group-item"><a href="${pageContext.request.contextPath}/scholar/getScholarsBySchool?school=武汉大学">武汉大学</a></li>
                            <li class="list-group-item"><a href="${pageContext.request.contextPath}/scholar/getScholarsBySchool?school=北京大学">北京大学</a></li>
                            <li class="list-group-item"><a href="${pageContext.request.contextPath}/scholar/getScholarsBySchool?school=四川大学">四川大学</a></li>
                            <li class="list-group-item"><a href="${pageContext.request.contextPath}/scholar/getScholarsBySchool?school=重庆大学">重庆大学</a></li>
                            <li class="list-group-item"><a href="${pageContext.request.contextPath}/scholar/getScholarsBySchool?school=上海交通大学">上海交通大学</a></li>
                            <li class="list-group-item"><a href="${pageContext.request.contextPath}/scholar/getScholarsBySchool?school=华东师范大学">华东师范大学</a></li>
                            </div>
                        </div>
                    </div>

                    <div class="col-lg-4 right_part">
                        <div class="dropdown">
                            <div class="dropbtn">211院校</div>
                            <div class="dropdown-content">
                              <li class="list-group-item"><a href="${pageContext.request.contextPath}/scholar/getScholarsBySchool?school=华东师范大学">范大学</a></li>
                              <li class="list-group-item"><a href="${pageContext.request.contextPath}/scholar/getScholarsBySchool?school=华东师范大学">华东师范大学</a></li>
                              <li class="list-group-item"><a href="${pageContext.request.contextPath}/scholar/getScholarsBySchool?school=华东师范大学">华东师范大学</a></li>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 right_part">
                    <div class="dropdown">
                        <div class="dropbtn">普通院校</div>
                        <div class="dropdown-content">
                            <li class="list-group-item"><a href="${pageContext.request.contextPath}/scholar/getScholarsBySchool?school=西安邮电大学">西安邮电大学</a></li>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-6">
                                <ul class="pagination">
                                    <li><a href="${pageContext.request.contextPath}/scholar/getScholarsBySchool?school=${school}&page=1&size=5" aria-label="Previous">首页</a></li>
                                    <li><a href="${pageContext.request.contextPath}/scholar/getScholarsBySchool?school=${school}&page=${pageInfos.pageNum-1}&size=5">上一页</a></li>
                                    <c:forEach items="${pageInfos.navigatepageNums}" var="pageNumber">
                                        <c:if test="${pageNumber==pageInfos.pageNum}">
                                            <li class="active"><a href="${pageContext.request.contextPath}/scholar/getScholarsBySchool?school=${school}&page=${pageNumber}&size=5">${pageNumber}</a></li>
                                        </c:if>
                                        <c:if test="${pageNumber!=pageInfos.pageNum}">
                                            <li><a href="${pageContext.request.contextPath}/scholar/getScholarsBySchool?school=${school}&page=${pageNumber}&size=5">${pageNumber}</a></li>
                                        </c:if>
                                    </c:forEach>
                                    <li><a href="${pageContext.request.contextPath}/scholar/getScholarsBySchool?school=${school}&page=${pageInfos.pageNum+1}&size=5">下一页</a></li>
                                    <li><a href="${pageContext.request.contextPath}/scholar/getScholarsBySchool?school=${school}&page=${pageInfos.pages}&size=5" aria-label="Next">尾页</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
