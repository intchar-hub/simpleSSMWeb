...
<head>
    ...
    <style type="text/css">
        *{ margin: 0; padding: 0; font-family: "微软雅黑";}
        ...
        html{ background: url("static/image/login-bg.jpg") center no-repeat; width: 100%; height: 100%; min-width: 1200px;}
        img{ max-width: 100%;}
...
<div class="login-bg">
    <div class="contater">
        <div class="login row">
            <h4>请登录</h4>
            <form class="form-horizontal" role="form" accept-charset="utf-8" method="post" action="${pageContext.request.contextPath}/user/login" id="form_login">
                ...
                <button class="btn btn-default btn-block" type="submit" id="submit-btn">立即登录</button>
            </form>
        </div>
